...
export const Card = ({ peerInfo }: PeerCardProps) => {
  return (
    <div className="w-full h-full p-3 space-y-1 hover:bg-blue-50 hover:border-blue-200 transition-all cursor-pointer rounded-lg bg-white border border-neutral-200 text-sm">
